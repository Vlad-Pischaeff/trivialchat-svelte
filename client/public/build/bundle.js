...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(108:3) {#if messages.length !== 0}",
    		ctx
    	});
    ...
    // (110:5) {#if (message.msg === "manager is OFFLINE..." ||          message.msg === "manager is ONLINE...")}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 111, 8, 3485);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(110:5) {#if (message.msg === \\\"manager is OFFLINE...\\\" ||          message.msg === \\\"manager is ONLINE...\\\")}",
    		ctx
    	});
    ...
    // (109:4) {#each messages as message }
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(109:4) {#each messages as message }",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file, 132, 3, 4235);
    			attr_dev(div4, "class", "chat_input");
    			add_location(div4, file, 127, 2, 4039);
    			attr_dev(footer, "class", "cp_footer");
    			add_location(footer, file, 126, 1, 4009);
    			attr_dev(main, "class", "cp");
    			attr_dev(main, "id", "App");
    			add_location(main, file, 95, 0, 2926);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		if (Object.entries(Session).length === 0) {
    			...
    			let response = await fetch(`${URL}/api/auth/usersite/${Session.userHOST}`).then(response => response.json());
